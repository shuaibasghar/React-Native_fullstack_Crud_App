...
import {RootStackParamList} from './Menus/ScreenMenu';
...
const EditModal: React.FC<Props> = ({modalVisible, setModalVisible, post}) => {
  ...
  //handle update post
  const updatePostHandler = async (id: string) => {
    try {
      setLoading(true);
